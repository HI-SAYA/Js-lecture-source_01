...
console.log(str.endsWith('va', 4));     // 'Java'가 va로 끝나는지, 4인덱스를 기준으로 앞으로(-1기준)봤을때 va로 끝나는지.
console.log('--------------------------------');
...
console.log(str.substring(1,4));    // 두번째 인덱스 위치 바로 이전 문자까지        // ava
console.log(str.substring(1));      // 두번째 인수 생략 시 문자열 끝까지
console.log(str.substring(4,1));    // 인수 교환하여 기능, 알아서 숫자 뒤집어서 반환 // ava
...
console.log(str3.split(''));        // 인수로 빈 문자열을 전달하면 각 문자를 모두 분리 (띄어쓰기 포함)
